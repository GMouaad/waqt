...
- [install.sh](https://github.com/GMouaad/waqt/blob/main/install.sh) for Linux/macOS
- [install.ps1](https://github.com/GMouaad/waqt/blob/main/install.ps1) for Windows
...
If you're an existing user with a pip-based setup and want to switch to uv, see the **[UV Migration Guide](uv-migration.md)** for step-by-step instructions.
...
2. Review the project's [Home Page](index.md)
