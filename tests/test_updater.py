...
class TestPlatformDetection:
    ...
    def test_get_platform_info(self):
        ...
        # Check that os_name is one of expected values
        assert os_name in ["linux", "macos", "windows", "darwin"]
        
        # Check that arch is reasonable
        assert arch in ["amd64", "arm64", "x86_64", "aarch64"]
